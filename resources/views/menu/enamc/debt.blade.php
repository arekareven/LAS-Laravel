{{-- debt here --}}
<div class="tab-pane fade" id="v-pills-debt-here" role="tabpanel" aria-labelledby="v-pills-debt-here-tab">
    <div class="was-validated tab-content" id="nav-tabContent">
        <div class="row">
            <p>
                <a class="btn btn-outline-secondary dropdown-toggle" data-bs-toggle="collapse" href="#collapseDebt"
                    role="button" aria-expanded="false" aria-controls="collapseDebt">
                    Lihat Data
                </a>
            </p>
            <div class="collapse" id="collapseDebt">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-select" aria-label="Default select example" id="from_debt_here"
                    name="from_debt_here_column" required>
                    <option value=""></option>
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-select" aria-label="Default select example" id="to_debt_here" name="to_after_column"
                    required>
                    <option value=""></option>
                    @foreach ($approximation as $data)
            ...
            <div class="form-group col-md-6">
                ...
                <input type="number" id="amount_debt_here" class="form-control" name="amount_debt_here_column"
                    required>
            </div>
