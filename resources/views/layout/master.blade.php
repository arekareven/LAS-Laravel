                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <h6 class="dropdown-header">
                                                <a href="https://mail.google.com/mail/" target="__blank">Gmail</a>
                                            </h6>
                                        </li>
                                    </ul>
                                </li>
                                        ...
                                        <li class="dropdown-item notification-item">
                                            <a class="d-flex align-items-center" href="#">
                                                ...
                                                <div class="notification-text ms-4">
                                                    <p class="notification-title font-bold">Permohonan a/n Debitur</p>
                                                    <p class="notification-subtitle font-thin text-sm">Disetujui</p>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            ...
                                            <p class="mb-0 text-sm text-gray-600">{{ Auth::user()->area_kerja }}</p>
                                        </div>
