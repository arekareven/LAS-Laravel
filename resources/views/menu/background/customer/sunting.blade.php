        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('customer.update',$get_customer->id) }}" method="put">
                        @csrf
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group col-md-10">
                                            ...
                                            <input type="number" id="office_number" class="form-control"
                                                name="office_number_column" value="{{ $get_customer->office_number }}" required>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group col-md-10">
                                            ...
                                            <input type="text" id="mate_name" class="form-control"
                                                placeholder="Nama Nasabah" name="mate_name_column" value="{{ $get_customer->mate_name }}" required>
                                            <div class="invalid-feedback">
                                                Isian nama tidak boleh kosong
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group col-md-10">
                                            ...
                                            <input type="text" id="mate_place_of_birth" class="form-control"
                                                placeholder="Kota" name="mate_place_of_birth_column" value="{{ $get_customer->mate_place_of_birth }}" required>
                                            <div class="invalid-feedback">Isian tempat lahir tidak boleh kosong</div></div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group col-md-10">
                                            ...
                                            <input type="date" id="mate_date_of_birth" class="form-control"
                                                placeholder="City" name="mate_date_of_birth_column" value="{{ $get_customer->mate_date_of_birth }}" required>
                                            <div class="invalid-feedback">Isian tanggal lahir tidak boleh kosong</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group col-md-10">
                                            ...
                                            <input type="number" id="mate_phone_number" class="form-control"
                                                placeholder="Nomor HP" name="mate_phone_number_column" value="{{ $get_customer->mate_phone_number }}" required>
                                            <div class="invalid-feedback">
                                                Isian no tlp tidak boleh kosong
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group col-md-10">
                                            ...
                                            <input type="text" id="mate_profession" class="form-control"
                                                placeholder="Profesi" name="mate_profession_column" value="{{ $get_customer->mate_profession }}" required>
                                    ...
                                    <div class="form-group col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="mate_residence_address" class="form-control"
                                                name="mate_residence_address_column" placeholder="Alamat Domisili" required> {{ $get_customer->mate_residence_address }}</textarea>
                                            <div class="invalid-feedback">Isian alamat tidak boleh kosong</div>
                                        </div>
                                    </div>
                                    <div class="form-group col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="mate_id_card_address" class="form-control"
                                                name="mate_id_card_address_column" placeholder="Alamat sesuai KTP" required> {{ $get_customer->mate_id_card_address }}"</textarea>
                                            <div class="invalid-feedback">Isian alamat tidak boleh kosong</div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group col-md-10">
                                            ...
                                            <input type="text" id="family_name" class="form-control"
                                                placeholder="Nama Nasabah" name="family_name_column" value="{{ $get_customer->family_name }}" required>
                                            <div class="invalid-feedback">
                                                Isian nama tidak boleh kosong
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group col-md-10">
                                            ...
                                            <input type="number" id="family_phone_number" class="form-control"
                                                placeholder="Nomor HP" name="family_phone_number_column" value="{{ $get_customer->family_phone_number }}" required>
                                            <div class="invalid-feedback">
                                                Isian no tlp tidak boleh kosong
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group col-md-10">
                                            ...
                                            <select class="form-select" aria-label="Default select example" id="family_relationship" name="family_relationship_column" required>
                                                <option  value="{{ $get_customer->family_relationship }}"> {{ $get_customer->family_relationship }}</option>
                                    ...
                                    <div class="form-group col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="family_residence_address" class="form-control"
                                                name="family_residence_address_column" placeholder="Alamat Domisili" required>{{ $get_customer->family_residence_address }}</textarea>
                                            <div class="invalid-feedback">Isian alamat tidak boleh kosong</div>
                                        </div>
                                    </div>
                                </div>
